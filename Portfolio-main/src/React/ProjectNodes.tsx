...
const projects = [
    ...
    },
    {
        id: 2,
        title: "ZeroCore",
        desc: "Es una plataforma B2B pensada para construir productos basados en conocimiento, recuperación y orquestación de agentes.",
        longDesc: "Es una plataforma B2B pensada para construir productos basados en conocimiento, recuperación y orquestación de agentes. Actúa como cerebro compartido para el ecosistema de aplicaciones: gestiona bases de conocimiento por tenant, autenticación y lógica de negocio reutilizable, expuesta como API para que otros productos o servicios agénticos se integren sin duplicar infraestructura.",
        tech: ["Python", "FastAPI", "PostgreSQL", "Docker", "Next.js"],
        image: "/mcarcos.github.io/zerocore_11zon.webp",
        github: "#",
        demo: "#",
        color: "#a476ff",
    },
    {
        id: 3,
        title: "Frost",
        desc: "Asistente de IA multicanal (WhatsApp, Email) para negocios, con orquestación por agentes.",
        longDesc: "Producto de atención al cliente impulsado por IA que integra WhatsApp e Email en un mismo flujo conversacional. Usa agentes orquestados con LangGraph para tomar decisiones, gestiona documentos con revisión humana (HITL) y se conecta a ZeroCore como fuente de conocimiento y contexto por tenant.",
        tech: ["Python", "FastAPI", "LangGraph", "PostgreSQL", "LangChain","Next.js","Whatsapp"],
        image: "/mcarcos.github.io/frost_11zon.webp",
        github: "#",
        demo: "#",
        color: "#a476ff",
    },
    {
        id: 4,
        title: "Payé Digital",
        desc: "Aplicación web de la empresa Payé Digital",
        longDesc: "Aplicación web de la empresa Payé Digital, orientada a la gestión y presentación de información de negocio con una interfaz moderna y responsive.",
        tech: ["React", "Next.js", "TypeScript", "TailwindCSS"],
        image: "/mcarcos.github.io/paye_11zon.webp",
        github: "#",
        demo: "https://payedigital.es/",
        color: "#a476ff",
    },
    {
        id: 5,
        title: "Pepa",
        desc: "Software de facturación electrónica adaptado a Verifactu.",
        longDesc: "Aplicación Full Stack de facturación pensada para autónomos y pequeñas empresas, compatible con los requisitos de Verifactu (sistema de facturación verificable de la AEAT). Incluye gestión de facturas, clientes y pagos, con integración de Stripe para suscripciones.",
        tech: ["React", "Next.js", "Python", "FastAPI", "Stripe", "PostgreSQL"],
        image: "/mcarcos.github.io/pepa_11zon.webp",
        github: "#",
        demo: "https://pepa.payedigital.es/pepa",
        color: "#a476ff",
    },
    {
        id: 6,
        title: "Darytravel",
        desc: "Plataforma de gestión de viajes con backend propio en Python.",
        longDesc: "Aplicación Full Stack para la creación y gestión de viajes, pensada para ayudar a empresas del sector agilizando el trabajo con IA y dedicando una experiencia de usuario ágil y óptima.",
        tech: ["Python", "FastAPI", "React", "PostgreSQL"],
        image: "/mcarcos.github.io/darytravel_11zon.webp",
        github: "#",
        demo: "#",
        color: "#a476ff",
    }
